...
const data = [
	{
		...
		description: '인액터스 테스트 입니다.인액터스 테스트 입니다.인액터스 테스트 입니다.인액터스 테스트 입니다.인액터스 테스트 입니다.인액터스 테스트 입니다.인액터스 테스트 입니다.인액터스 테스트 입니다.인액터스 테스트 입니다.인액터스 테스트 입니다.인액터스 테스트 입니다.인액터스 테스트 입니다.인액터스 테스트 입니다.인액터스 테스트 입니다.인액터스 테스트 입니다.인액터스 테스트 입니다.인액터스 테스트 입니다. ',
	},
	{
		key: '2',
		userName: '이유경',
